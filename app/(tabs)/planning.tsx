          ...
          <ScrollView style={styles.dayViewContent} showsVerticalScrollIndicator={false}>
            {selectedDay?.activities.length === 0 ? (
              <View style={styles.emptyState}>
                ...
                <TouchableOpacity 
                  style={[styles.addEventButtonEmpty, { backgroundColor: isDarkMode ? '#374151' : '#FFD840' }]} 
                  onPress={() => setIsAddEventVisible(true)}
                  activeOpacity={0.7}
                  hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
                >
                  <Plus size={20} color={isDarkMode ? '#F9FAFB' : '#2E2E2E'} strokeWidth={2} />
                  <Text style={[styles.addEventButtonEmptyText, { color: isDarkMode ? '#F9FAFB' : '#2E2E2E' }]}>
